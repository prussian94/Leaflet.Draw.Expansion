...
L.Arc = L.Polyline.extend({
  ...
  initialize: function initialize(_ref) {
    var _ref$center = _ref.center,
      ...
      rotationAngle = _ref.rotationAngle || 0,
  ...
  setRotationAngle: function setRotationAngle() {
    var rotationAngle =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;

    this._rotationAngle = ((rotationAngle % 360) + 360) % 360; // Ensure angle is between 0 and 360
    return this.redraw();
  },
  ...
  getLatLngs: function getLatLngs() {
    ...
    for (var i = 0; i < ptCount; i++) {
      var useAngle =
        this.getStartBearing() + deltaAngle * i + this.getRotationAngle();
      latlngs.push(
    ...
    latlngs.push(
      this.computeDestinationPoint(
        ...
        this.getRadiusX(),
        this.getRadiusY(),
        this.getEndBearing() + this.getRotationAngle(),
      ),
    );
    return latlngs;
  },
...
L.arc = function (_ref2) {
  var _ref2$center = _ref2.center,
    ...
    rotationAngle = _ref2.rotationAngle || 0,
